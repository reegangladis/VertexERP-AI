...
class Location(Base):
    """Physical organizational site/facility (Office, Warehouse, Plant, Store)."""
    ...
    location_type: Mapped[str] = mapped_column(
        String(32), default="OFFICE", server_default=text("'OFFICE'")
    )
    ...
    country: Mapped[str] = mapped_column(String(3), default="USA", server_default=text("'USA'"))
