...
from app.models.observability import SystemMetric, ApplicationLog, Trace, Alert
...
async def test_search_logs():
    ...
    logs, count = await service.search_logs(org_id, keyword="conflict", page=1, page_size=10)
...
async def test_acknowledge_alert_status():
    ...
    res = await service.update_alert(org_id, alert_id, update_payload, "sre.engineer@vertex.ai")
