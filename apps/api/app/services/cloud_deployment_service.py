...
class CloudDeploymentService:
    ...
    def get_deployment_strategies_spec(self) -> dict[str, Any]:
        ...
        return {
            "canary": {
                "description": "Gradual traffic rollout (10% -> 50% -> 100%)",
                "zero_downtime": True,
            },
            "blue_green": {
                "description": "Parallel environment switchover",
                "zero_downtime": True,
            },
            "rolling": {
                "description": "Pod-by-pod replacement via Kubernetes RollingUpdate",
                "zero_downtime": True,
            },
        }
