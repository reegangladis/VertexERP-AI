...
class ApiGatewayService:
    ...
    def _register_default_routes(self):
        self._routes["/v1/erp/sync"] = GatewayRoutePolicy(
            route_path="/v1/erp/sync", target_service="erp_connector", version="v1", rate_limit_rps=50, cache_ttl_seconds=0
        )
        self._routes["/v1/crm/contacts"] = GatewayRoutePolicy(
            route_path="/v1/crm/contacts", target_service="crm_connector", version="v1", rate_limit_rps=100, cache_ttl_seconds=60
        )
        self._routes["/v2/analytics/reports"] = GatewayRoutePolicy(
            route_path="/v2/analytics/reports", target_service="bi_platform", version="v2", rate_limit_rps=20, cache_ttl_seconds=300
        )

    def check_rate_limit(self, client_identifier: str, limit_rps: int = 50) -> Tuple[bool, int]:
    ...
    def set_cached_response(self, cache_key: str, payload: Any, ttl_seconds: int = 60) -> None:
    ...
    def route_request(self, path: str, method: str = "GET", headers: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
