...
class RAGEmbeddingService:
    ...
    async def get_embedding(
        ...
        """
        cache_key = hashlib.sha256(f"{provider}:{model_name}:{text}".encode("utf-8")).hexdigest()
    ...
    def get_provider_metadata(self, provider: str, model_name: str) -> dict[str, Any]:
        ...
        metadata = {
            "openai": {
                "text-embedding-3-small": {"dimension": 1536, "max_tokens": 8191, "version": "v1.0"},
                "text-embedding-3-large": {"dimension": 3072, "max_tokens": 8191, "version": "v1.0"},
                "text-embedding-ada-002": {"dimension": 1536, "max_tokens": 8191, "version": "v1.0"},
            },
            "gemini": {
                "text-embedding-004": {"dimension": 768, "max_tokens": 2048, "version": "v1.0"},
            },
            "azure_openai": {
                "text-embedding-ada-002": {"dimension": 1536, "max_tokens": 8191, "version": "v1.0"},
            },
            "anthropic": {
                "voyage-large-2-instruct": {"dimension": 1024, "max_tokens": 4000, "version": "v1.0"},
            },
            "local": {
                "all-MiniLM-L6-v2": {"dimension": 384, "max_tokens": 512, "version": "v2.0"},
            }
        }
        
        provider_data = metadata.get(provider, {})
        return provider_data.get(model_name, {"dimension": 1536, "max_tokens": 2048, "version": "v1.0"})
