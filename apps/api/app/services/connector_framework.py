...
class StripeConnector(BaseConnector):
    ...
    def execute_action(
        ...
        return ConnectorExecuteResponse(
            ...
            latency_ms=18.6,
            data={
                "stripe_payment_intent_id": "pi_3Nxx12345678",
                "status": "succeeded",
...
class S3Connector(BaseConnector):
    ...
    def execute_action(
        ...
        return ConnectorExecuteResponse(
            ...
            latency_ms=14.2,
            data={
                "bucket": payload.get("bucket", "vertexerp-data"),
                "key": payload.get("key", "file.pdf"),
                "status": "uploaded",
            },
        )
...
class OpenAIConnector(BaseConnector):
    ...
    def execute_action(
        ...
        return ConnectorExecuteResponse(
            ...
            latency_ms=85.0,
            data={
                "response_text": "Enterprise AI response generated successfully.",
                "usage_tokens": 120,
            },
        )
...
class ConnectorFrameworkRegistry:
    ...
    def register_connector(
        self, provider_slug: str, connector_cls: type[BaseConnector]
    ):
        self._connectors[provider_slug.lower()] = connector_cls

    def get_connector(
        self, provider_slug: str, config: dict[str, Any] | None = None
    ) -> BaseConnector | None:
