...
from app.schemas.integration import QueueMessageOut
...
class MessageQueueService:
    ...
    def dequeue_message(self, queue_name: str, consumer_id: str) -> Optional[Dict[str, Any]]:
    ...
    def nack_message(self, queue_name: str, message_id: str, error_details: str) -> bool:
