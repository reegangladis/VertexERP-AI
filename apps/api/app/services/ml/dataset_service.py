...
class MLDatasetGenerator:
    ...
    def generate_hr_attrition_dataset(records: int = 100) -> List[Dict[str, Any]]:
        ...
        for i in range(1, records + 1):
            ...
            attrition = 1 if (sat < 2.5 and overtime > 15) or (sal_pct < 30 and overtime > 20) else 0
    ...
    def generate_sales_forecasting_dataset(records: int = 100) -> List[Dict[str, Any]]:
        ...
        for i in range(1, records + 1):
            ...
            target_sales = round(hist_sales * (1.0 + growth) + (pipeline_deals * 3500), 2)
    ...
    @staticmethod
    def generate_inventory_optimization_dataset(records: int = 100) -> List[Dict[str, Any]]:
        data = []
        for i in range(1, records + 1):
