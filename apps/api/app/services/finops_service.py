...
class FinOpsService:
    ...
    def get_monthly_cost_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "budget_status": "WITHIN_BUDGET" if utilized_percent < 85.0 else "WARNING_THRESHOLD",
            "generated_at": datetime.now(UTC).isoformat(),
        }

    def evaluate_budget_alert(self, current_spend: float, budget: float) -> Dict[str, Any]:
        ...
        return {
            ...
            "severity": "HIGH" if percent >= 95.0 else ("MEDIUM" if percent >= 85.0 else "NORMAL"),
        }
