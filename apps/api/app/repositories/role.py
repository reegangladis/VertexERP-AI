...
class RoleRepository(BaseRepository[Role]):
    ...
    async def ensure_default_roles(
        ...
        standard_roles = [
            ...
            (
                "Finance Manager",
                "Accounting, invoices, budgets, and chart of accounts access",
            ),
            ("CRM Manager", "Customer relations, leads, deals, and support access"),
            (
                "Inventory Manager",
                "Products, warehouses, purchase orders, and stock access",
            ),
            (
                "Manufacturing Manager",
                "BOM, routings, work centers, and shop floor access",
            ),
