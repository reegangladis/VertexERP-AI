...
class JournalEntryResponse(FinanceBaseModel):
    ...
    ai_fraud_score: float | None = None
...
class CustomerInvoiceResponse(FinanceBaseModel):
    ...
    status: str
    notes: str | None = None
    ai_default_risk: float | None = None
...
class AssetCategoryCreate(FinanceBaseModel):
    ...
    asset_gl_account_id: uuid.UUID | None = None
    depreciation_gl_account_id: uuid.UUID | None = None
    accumulated_depr_gl_account_id: uuid.UUID | None = None
