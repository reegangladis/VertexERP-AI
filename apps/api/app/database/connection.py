...
def create_db_engine() -> AsyncEngine:
    ...
    try:
        ...
        logger.warning(f"PostgreSQL engine creation warning: {e}. Defaulting to SQLite fallback.")
        return create_async_engine("sqlite+aiosqlite:///./vertexerp.db", future=True, echo=False)
...
def set_fallback_sqlite_engine() -> None:
    ...
    engine = create_async_engine("sqlite+aiosqlite:///./vertexerp.db", future=True, echo=False)
