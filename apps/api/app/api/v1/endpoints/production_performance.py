...
from app.models.production import PerformanceReport, LoadTestResult
...
@router.post("/load-test", response_model=LoadTestResultOut, status_code=status.HTTP_201_CREATED)
