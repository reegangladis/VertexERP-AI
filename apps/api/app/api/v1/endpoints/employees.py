...
from app.models.employee import Employee, EmployeeProfile, EmployeeDocument
from app.models.department import Department
from app.models.designation import Designation
from app.repositories.hr_mgmt import EmployeeRepository, EmployeeProfileRepository, EmployeeDocumentRepository
from app.services.hr_mgmt import EmployeeService, DocumentUploadService
from app.schemas.hr_mgmt import EmployeeResponse, EmployeeCreate, EmployeeUpdate, EmployeeStatusUpdate, EmployeeDocumentResponse
...
async def update_employee_status(
    ...
    stmt = select(Employee).where(Employee.id == updated.id).options(selectinload(Employee.profile))
    res = await service.repository.db.execute(stmt)
    emp_reloaded = res.scalar_one()
...
@router.get("/{id}/documents", response_model=APIResponse[List[EmployeeDocumentResponse]])
async def list_employee_documents(
    ...
    stmt = select(EmployeeDocument).where(EmployeeDocument.employee_id == id, EmployeeDocument.is_deleted == False)
