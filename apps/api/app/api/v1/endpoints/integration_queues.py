...
from app.schemas.integration import QueueMessagePublish
...
async def enqueue_message(
    payload: QueueMessagePublish, db: AsyncSession = Depends(get_db)
):
...
async def nack_message(
    queue_name: str, message_id: str, error_details: str = "Processing error"
):
