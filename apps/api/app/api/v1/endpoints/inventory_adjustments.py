...
from app.models.inventory_transaction import InventoryAdjustment
from app.repositories.inventory_mgmt import InventoryAdjustmentRepository
from app.schemas.inventory_mgmt import InventoryAdjustmentResponse, InventoryAdjustmentCreate
