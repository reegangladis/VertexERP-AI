...
from app.schemas.org_mgmt import DocumentResponse, BulkDeleteRequest
...
async def download_document(
    ...
    if doc.storage_provider != "local":
        raise HTTPException(status_code=400, detail=f"File is stored on remote provider: {doc.storage_provider}. Cloud download stub active.")
