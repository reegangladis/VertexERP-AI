...
async def get_manufacturing_dashboard(
    ...
    return standard_json_response(
        ...
        success=True,
        data=metrics,
        message="Manufacturing dashboard metrics fetched successfully",
    )
...
async def list_boms(
    ...
    if search:
        stmt = stmt.where(
            or_(
                BillOfMaterial.code.ilike(f"%{search}%"),
                BillOfMaterial.version.ilike(f"%{search}%"),
            )
        )
    ...
    return standard_json_response(
        ...
        success=True,
        data=detailed_boms,
        message="BOMs listed successfully",
    )


@router.post(
    "/boms",
    response_model=APIResponse[BOMResponse],
...
@router.post(
    "/boms/{bom_id}/cost-rollup", response_model=APIResponse[BOMCostRollupResponse]
)
async def calculate_bom_cost_rollup(
    ...
    return standard_json_response(
        ...
        success=True,
        data=res,
        message="BOM Cost Rollup calculated successfully",
    )
...
async def list_routings(
    ...
    if search:
        stmt = stmt.where(
            or_(Routing.code.ilike(f"%{search}%"), Routing.name.ilike(f"%{search}%"))
        )
    ...
    return standard_json_response(
        ...
        success=True,
        data=detailed,
        message="Routings listed successfully",
    )


@router.post(
    "/routings",
    response_model=APIResponse[RoutingResponse],
    status_code=status.HTTP_201_CREATED,
)
async def create_routing(
    ...
    return standard_json_response(
        ...
        success=True,
        data=routing,
        message="Manufacturing Routing created successfully",
    )
...
async def list_work_centers(
    ...
    return standard_json_response(
        ...
        success=True,
        data=wcs,
        message="Work Centers listed successfully",
    )


@router.post(
    "/work-centers",
    response_model=APIResponse[WorkCenterResponse],
    status_code=status.HTTP_201_CREATED,
)
async def create_work_center(
    ...
    if not current_user.organization_id:
        raise HTTPException(status_code=400, detail="User missing organization binding")
    wc = await service.create_work_center(
        current_user.organization_id, data, current_user.id
    )
    return standard_json_response(
        status_code=status.HTTP_201_CREATED,
...
@router.post(
    "/machines",
    response_model=APIResponse[MachineResponse],
    status_code=status.HTTP_201_CREATED,
)
...
@router.post(
    "/machines/downtime",
    response_model=APIResponse[MachineDowntimeResponse],
    status_code=status.HTTP_201_CREATED,
)
async def log_machine_downtime(
    ...
    return standard_json_response(
        ...
        success=True,
        data=dt,
        message="Machine downtime logged successfully",
    )


@router.get(
    "/machines/{machine_id}/downtimes",
    response_model=APIResponse[list[MachineDowntimeResponse]],
)
async def get_machine_downtimes(
    ...
    return standard_json_response(
        ...
        success=True,
        data=downtimes,
        message="Machine downtimes fetched successfully",
    )


# --- PRODUCTION ORDERS ---
@router.get(
    "/production-orders", response_model=APIResponse[list[ProductionOrderResponse]]
)
...
async def create_production_order(
    ...
    if not current_user.organization_id:
        raise HTTPException(status_code=400, detail="User missing organization binding")
    po = await service.create_production_order(
        current_user.organization_id, data, current_user.id
    )
    return standard_json_response(
        status_code=status.HTTP_201_CREATED,
...
@router.get(
    "/production-orders/{order_id}", response_model=APIResponse[ProductionOrderResponse]
)
...
@router.post(
    "/production-orders/{order_id}/reserve-materials",
    response_model=APIResponse[MaterialReservationResponse],
)
async def reserve_production_order_materials(
    ...
    return standard_json_response(
        ...
        success=True,
        data=res,
        message="Materials allocated and reserved successfully",
    )


@router.get(
    "/production-orders/{order_id}/cost-summary",
    response_model=APIResponse[ProductionCostSummaryResponse],
)
async def get_production_order_cost_summary(
    ...
    return standard_json_response(
        ...
        success=True,
        data=res,
        message="Production cost summary calculated successfully",
    )


@router.put(
    "/production-orders/items/{item_id}",
    response_model=APIResponse[ProductionOrderItemResponse],
)
...
@router.post(
    "/shop-floor/logs",
    response_model=APIResponse[ProductionLogResponse],
    status_code=status.HTTP_201_CREATED,
)
async def log_shop_floor_production(
    ...
    return standard_json_response(
        ...
        success=True,
        data=log,
        message="Shop floor production logged successfully",
    )


# --- QUALITY CONTROL ---
@router.get(
    "/quality/inspections", response_model=APIResponse[list[QualityInspectionResponse]]
)
async def list_quality_inspections(
    ...
    return standard_json_response(
        ...
        success=True,
        data=detailed,
        message="Quality inspections listed successfully",
    )
...
async def create_quality_inspection(
    ...
    if not current_user.organization_id:
        raise HTTPException(status_code=400, detail="User missing organization binding")
    insp = await service.create_quality_inspection(
        current_user.organization_id, data, current_user.id
    )
    return standard_json_response(
        status_code=status.HTTP_201_CREATED,
...
@router.get(
    ...
    response_model=APIResponse[list[MaintenanceRequestResponse]],
)
...
@router.post(
    "/maintenance/requests",
    response_model=APIResponse[MaintenanceRequestResponse],
    status_code=status.HTTP_201_CREATED,
)
...
@router.post(
    "/maintenance/logs",
    response_model=APIResponse[MaintenanceLogResponse],
    status_code=status.HTTP_201_CREATED,
)
...
async def list_mrp_runs(
    ...
    stmt = (
        ...
        .order_by(desc(MRPRun.created_at))
        .offset(skip)
        .limit(limit)
    )
    res = await service.db.execute(stmt)
    ...
    return standard_json_response(
        ...
        success=True,
        data=runs,
        message="MRP runs fetched successfully",
    )


@router.post(
    "/mrp/runs",
    response_model=APIResponse[MRPRunResponse],
    status_code=status.HTTP_201_CREATED,
)
async def execute_mrp_run(
    ...
    return standard_json_response(
        ...
        success=True,
        data=mrp,
        message="Material Requirement Planning run completed successfully",
    )
