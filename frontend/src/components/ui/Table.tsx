...
export const TableHeader: React.FC<React.HTMLAttributes<HTMLTableSectionElement>> = ({
  ...
  <thead className={cn("bg-slate-900/90 border-b border-slate-800 text-xs font-semibold uppercase tracking-wider text-slate-400", className)} {...props}>
    {children}
  </thead>
);
...
export const TableBody: React.FC<React.HTMLAttributes<HTMLTableSectionElement>> = ({
  ...
  <tbody className={cn("divide-y divide-slate-800/60 bg-slate-900/20 text-slate-200", className)} {...props}>
    {children}
  </tbody>
);
